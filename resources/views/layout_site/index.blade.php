                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            <a href="index.html" class="nav-item nav-link active">BANNER PRODUTOS </a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 my-auto text-center text-md-end text-white">
                        ...
                        Designed By Ritz <a class="border-bottom" href="https://htmlcodex.com"</a> Distributed By <a class="border-bottom" href="https://themewagon.com">Ritz</a>
                    </div>
                </div>
            </div>
        </div>
